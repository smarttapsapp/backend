...
class RoleModel(Base):
    ...
    roleType = Column(Enum(AdminTypeEnum), nullable=False, default=AdminTypeEnum.INTERNAL)
...
class AdminModel(Base):
    ...
    companyAddress= Column(String(150), nullable=True)
    ...
    provider_auth = Column(Text, nullable=True)
    ...
    routes = relationship("TrainRouteModel", back_populates="provider")
...
class CustomerModel(Base):
    ...
    phonenumber = Column(String(13))
    gender = Column(Boolean, default=False,server_default='0')
    password = Column(String(255), nullable=True)
    ...
    address_submitted = Column(Boolean, default=False,server_default='0')
    nin_submitted = Column(Boolean, default=False)
    referalcode = Column(String(13), nullable=True)
    bvn_verified = Column(Boolean, default=False,server_default='0')
    nin_verified = Column(Boolean, default=False,server_default='0')
    kyc_completed = Column(Boolean, default=False,server_default='0')
    ...
    is_next_of_kin = Column(Boolean, default=False,server_default='0')
    ...
    hasAuthToken = Column(Boolean, default=False,server_default='0')
    hideBalance = Column(Boolean, default=False,server_default='0')
    autoFund = Column(Boolean, default=False,server_default='0')
    autoFundThreshold = Column(String(50),default='0',server_default='0')
    autoFundAmount = Column(String(50),default='0',server_default='0')
    account_status = Column(
        Enum(AccountStatusEnum), nullable=False, default=AccountStatusEnum.REG,server_default=AccountStatusEnum.REG.value
    )
    account_type = Column(
        Enum(AccountEnum), nullable=False, default=AccountEnum.INDIVIDUAL,server_default=AccountEnum.INDIVIDUAL.value
    )
    account_ratings = Column(Enum(AccountRatingEnum), default=AccountRatingEnum.BRONZE,server_default=AccountRatingEnum.BRONZE.value)
...
class CashOutModel(Base):
    ...
    amount= Column(String(20),default='0',server_default='0')
...
class ProductTypeModel(Base):
    ...
    provider_id = Column(Integer, ForeignKey("admins.id"))
    provider = relationship("AdminModel", backref="biller")
...
class PaymentModel(Base):
    ...
    fee = Column(String(25), default='0',server_default='0')
    recipient = Column(String(50), nullable=False)
    providerAmount = Column(String(50), nullable=True,default='0',server_default='0')
    commissionAmount = Column(String(50), nullable=True,default='0',server_default='0')
    payment_type = Column(Enum(PaymentEnum), nullable=False, default=PaymentEnum.DEBIT,server_default=PaymentEnum.DEBIT.value)
    channel =  Column(Enum(ChannelEnum), nullable=False, default=ChannelEnum.MOBILE,server_default=ChannelEnum.MOBILE.value)
    statusCode =  Column(Enum(TransactionCodeEnum), nullable=False, default=TransactionCodeEnum.PROCESSING,server_default=TransactionCodeEnum.PROCESSING.value)
    statusDescription =  Column(Enum(TransactionStatusEnum), nullable=False, default=TransactionStatusEnum.PROCESSING,server_default=TransactionStatusEnum.PROCESSING.value)
    balanceBefore = Column(String(25), default='0',server_default='0')
    balanceAfter = Column(String(25), default='0',server_default='0')
    provider_code = Column(String(10), nullable=True)
    packageId = Column(String(10), nullable=True)
    product_id = Column(Integer, ForeignKey('products.id'))
...
class NotificationModel(Base):
    ...
    message = Column(Text, default='0',server_default='0')
...
class StationModel(Base):
    ...
    depature = relationship("TrainRouteModel", foreign_keys="TrainRouteModel.sourceStation_id", back_populates="sourceStation")
    arrival = relationship("TrainRouteModel", foreign_keys="TrainRouteModel.destinationStation_id", back_populates="destinationStation")
...
class TicketModel(Base):
    ...
    admin_id = Column(Integer, ForeignKey('admins.id'), nullable=False,default=0,server_default='0')
    bus_id = Column(Integer, ForeignKey('buses.id'), nullable=True)
    train_id = Column(Integer, ForeignKey('trains.id'), nullable=True)
...
class GLAccountModel(Base):
    ...
    gl_balance = Column(String(20), nullable=False,default='0',server_default='0')
    is_active = Column(Boolean, default=True)
    created_at = Column(DateTime, default=func.now(),server_default=func.now())
...
class GLTransaction(Base):
    ...
    fee_amount       = Column(String(50), default=0,server_default='0')
    provider_cost    = Column(String(50), default=0,server_default='0')
    commission       = Column(String(50), default=0,server_default='0')
    merchant_com     = Column(String(50), default=0,server_default='0')
...
train_route = Table('train_route',
    ...
    Column('route_id', Integer, ForeignKey('train_routes.id',ondelete="CASCADE"), primary_key=True)
)
class TrainRouteModel(Base):
    ...
    sourceStation = relationship("StationModel", foreign_keys=[sourceStation_id], back_populates="depature")
    destinationStation = relationship("StationModel", foreign_keys=[destinationStation_id], back_populates="arrival")
    #trains = relationship("TrainModel", back_populates="route")
...
class TrainModel(Base):
    ...
    admin_id = Column(Integer, ForeignKey('admins.id'), nullable=True)
    route_id = Column(Integer, ForeignKey("train_routes.id"))
...
class PricingModel(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    route_id = Column(Integer, ForeignKey("train_routes.id"))
    #train_id = Column(Integer, ForeignKey("trains.id"), nullable=False)f4
    classType = Column(String(50), nullable=False)  # Economy, Business, First
    price = Column(String(25), nullable=False)
    per_km_rate = Column(String(50), nullable=False)
