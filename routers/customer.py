...
@router.post("/change/password",
    response_model=BaseResponse,
    response_model_exclude_unset=True,)
async def create_transaction_password(
...
@router.post("/link",
    response_model=BaseResponse,
    response_model_exclude_unset=True,  name="to update user information", tags=["users"])
...
@router.post("/update/otp",
    response_model=BaseResponse,
    response_model_exclude_unset=True,  name="verify user account information by OTP", tags=["users"])
